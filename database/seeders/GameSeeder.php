...
class GameSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Game::insert([
            ...
            ['name' => 'Elden ring', 'genre' => 'RPG', 'developer' => 'FromSoftware, Inc.', 'tags' => 'Action, Difficult, Fantasy' , 'description' => 'THE CRITICALLY ACCLAIMED FANTASY ACTION RPG. Rise, Tarnished, and be guided by grace to brandish the power of the Elden Ring and become an Elden Lord in the Lands Between.' , 'images' => 'eldenring.jpg', 'created_at' => $currentTimestamp,'updated_at'=> $currentTimestamp],
            
            ['name' => 'Cyberpunk 2077', 'genre' => 'Open world', 'developer' => 'CD PROJEKT RED', 'tags' => 'Cyberpunk, Open world, Sci-fi', 'description' => 'Cyberpunk 2077 is an open-world, action-adventure RPG set in the dark future of Night City — a dangerous megalopolis obsessed with power, glamor, and ceaseless body modification.' , 'images' => 'cyberpunk.jpg', 'created_at' => $currentTimestamp,'updated_at'=> $currentTimestamp],
